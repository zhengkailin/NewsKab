...
<div class="container headinfo">
    ...
    <div class="locaiton"><a href="/indexlist">首页</a>&gt;&gt;KAB课程</div>
</div>
<div class="container mianinfo">
    <ul>
        <c:forEach items="${course.datas}" var="course" >
        <li><a href="/courseById/${course.id}">· ${course.title}</a>
            <span class='pull-right'>${course.createDate}</span>
        </li>
        </c:forEach>
    </ul>
</div>
...
<script type="text/javascript">
    ...
    $(".tcdPageCode").createPage({
        pageCount:${course.totalPageCount},//总页数
        current:${course.currPageNo},//当前页数
...
//            $("#formList").submit();
            //--------------------------------------------------
            //         访问路径的方式
            location.href="${ctx}/courselist?currPageNo="+p;
        }
    });
</script>
</html>
